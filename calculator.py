...
textDisplay=Entry(cal,font=('arial',20,'bold'),textvariable=text_Input,bd=30,insertwidth=4,bg="lightgray",justify='right').grid(columnspan=4)
...
Addition=Button(cal,padx=16,pady=16,bd=8,fg='black',font=('arial',20,'bold'),text='+',bg="light green",command=lambda:btnClick("+")).grid(row=1,column=3)
...
Subtraction=Button(cal,padx=16,pady=16,bd=8,fg='black',font=('arial',20,'bold'),text='-',bg="light green",command=lambda:btnClick("-")).grid(row=2,column=3)
...
Multiplication=Button(cal,padx=16,pady=16,bd=8,fg='black',font=('arial',20,'bold'),text='*',bg="light green",command=lambda:btnClick("*")).grid(row=3,column=3)

###################################################################################################################################################################

btnClear=Button(cal,padx=16,pady=16,bd=8,fg='black',font=('arial',20,'bold'),text='C',bg="light pink",command=lambda:btnClearDisplay()).grid(row=4,column=0)
...
btnEqual=Button(cal,padx=16,pady=16,bd=8,fg='black',font=('arial',20,'bold'),text='=',bg="light green",command=lambda:btnEqualsInput()).grid(row=4,column=2)
Division=Button(cal,padx=16,pady=16,bd=8,fg='black',font=('arial',20,'bold'),text='/',bg="light green",command=lambda:btnClick("/")).grid(row=4,column=3)

###################################################################################################################################################################

print("Python's Calculator")
cal.mainloop()
